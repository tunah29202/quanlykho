...
import { API } from '@/commons/config/core/user.config'
...
const userService = {
    ...
    async getUserByNameEmail(params?: unknown): Promise<APIResponse<any[]>> {
        return await apiClient.get(API.GET_USER_BY_NAME_EMAIL, {
            params: params,
        })
    },
