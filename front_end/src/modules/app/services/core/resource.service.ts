...
import { API } from '@/commons/config/core/resource.config'
...
const resourceService = {
    ...
    async getresourceByNameEmail(params?: unknown): Promise<APIResponse<any[]>> {
        return await apiClient.get(API.GET_resource_BY_NAME_EMAIL, {
            params: params,
        })
    },
